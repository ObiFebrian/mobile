...
public class AppKalkulator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_kalkulator);
        ...
        tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((angka_pertama.getText().length()>0) && (angka_kedua.getText().length()>0))
                {
                    ...
                    Toast toast = Toast.makeText(AppKalkulator.this, "Mohon masukkan Angka pertama & Kedua", Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        });
